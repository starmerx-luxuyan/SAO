...
# All legacy and extended tools share one authoritative runtime. The outer social layer retains
# the Boss, raid-spatial and ordered-timeline behavior inherited below it.
if not isinstance(core_server.runtime, SocialTimelineAincradRuntime):
    core_server.runtime = SocialTimelineAincradRuntime(seed=0xA1C0)
