...
from sao_mcp.server_guild_autonomy import register_guild_autonomy_tools
...
if not isinstance(core_server.runtime, FullAincradRuntime):
    core_server.runtime = FullAincradRuntime(seed=0xA1C0)
...
register_guild_autonomy_tools(mcp, runtime)
