...
class HousingAincradRuntime(PopulationAincradRuntime):
    """Autonomous NPC/guild/population runtime plus persistent property ownership and interior world nodes."""
