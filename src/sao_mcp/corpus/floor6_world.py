...
def floor6_locations() -> dict[str, LocationDefinition]:
    return {
        ...
        "floor_6_cylon_lord_manor": LocationDefinition(
            ...
            safe_zone=True,
            provenance=_inferred(
                "Stachion lord's manor where Cylon gives Curse of Stachion; exact building geometry is abstracted."
            ),
        ),
        "floor_6_traveller_grave": LocationDefinition(
            ...
            safe_zone=True,
            provenance=_inferred(
                "Grave where Cylon asks the players to offer the missing golden cube. Exact city placement is abstracted."
            ),
        ),
        "floor_6_cylon_transport_carriage": LocationDefinition(
            ...
            ZoneKind.FIELD,
            provenance=_inferred(
                "Scenario-space node for Cylon's carriage transport and the Morte/Joe ambush on the road between Suribus and Stachion."
            ),
        ),
        "floor_6_myia_house": LocationDefinition(
            ...
            safe_zone=True,
            provenance=_inferred(
                "Theano's home in Stachion where Myia receives her mother's note and iron key; exact street placement is abstracted.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_dungeon_of_trials_entrance": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_inferred(
                "Main basement entrance beneath the Stachion lord's mansion. The golden key opens the original-route entrance.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_dungeon_of_trials": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_canon(
                "Puzzle-filled dungeon beneath the Stachion lord's mansion.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_dungeon_of_trials_secret_back_door": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_inferred(
                "Hidden rear entrance beneath a movable statue base in the manor garden. Terro reveals it in the release route.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_dungeon_of_trials_final_chamber": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_canon(
                "Deepest chamber of the Dungeon of Trials; the secret rear route reaches it directly.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_agate_key_shrine": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_inferred(
                "Southern shrine holding the Agate Key; the entrance has an unusually difficult puzzle. Exact room geometry is abstracted.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_castle_galey_storyteller_summit": LocationDefinition(
            ...
            ZoneKind.FIELD,
            provenance=_inferred(
                "Hidden stairway and summit above Castle Galey where Bouhroum offers the three-hour Meditation trial.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_castle_galey_spirit_tree_spring": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_canon(
                "Underground hot spring nourishing Castle Galey's spirit tree. Gindo poisons it under coercion during the Fallen Elf attack.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_qusack_rescue_cave": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_inferred(
                "Cave where Qusack's members are held hostage and Kysarah attacks the rescue party; exact cave geometry is abstracted.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_goskai": LocationDefinition(
            ...
            safe_zone=True,
            provenance=_canon(
                "Cave City in Floor 6's fourth area on the southern pursuit route.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_goskai_caves": LocationDefinition(
            ...
            ZoneKind.FIELD,
            provenance=_inferred(
                "Playable cave-field node around Goskai where Theano is sighted and Basalt Morpha is encountered; exact cave geometry is abstracted.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_murutsuki": LocationDefinition(
            ...
            safe_zone=True,
            provenance=_canon(
                "Central village in Floor 6's fifth area on the route to the Labyrinth.",
                PROGRESSIVE_6,
            ),
        ),
        "floor_6_labyrinth_golden_cube_breach": LocationDefinition(
            ...
            ZoneKind.DUNGEON,
            provenance=_inferred(
                "Theano uses the Golden Cube to dismantle labyrinth walls into blocks, leaving an abnormal direct route toward the boss chamber.",
                PROGRESSIVE_6,
            ),
        ),
    }
...
def floor6_connections() -> tuple[TravelConnection, ...]:
    p5 = _sim(
        "Travel durations are simulation; named endpoint relationships follow the Progressive Floor 6 route.",
        PROGRESSIVE_5,
    )
    p6 = _sim(
        "Travel durations are simulation; named endpoint relationships follow the Progressive Floor 6 route.",
