...
def low_floor_locations() -> dict[str, LocationDefinition]:
    rows = {
        ...
        "floor_3_forest_of_wavering_mists": LocationDefinition(
            "floor_3_forest_of_wavering_mists",
            3,
        ...
        # Floor 5
        "floor_5_mananaarena": LocationDefinition(
            "floor_5_mananaarena",
            5,
            "Mananarena",
            ZoneKind.SAFE_TOWN,
...
def low_floor_connections() -> tuple[TravelConnection, ...]:
    # Named geography and adjacency are canon-backed; exact travel durations are runtime calibration.
    ...
    return (
        ...
        TravelConnection("floor_5_ruins", "floor_5_mananaarena", 22 * 60_000, provenance=p),
        TravelConnection("floor_5_mananaarena", "floor_5_mananarena_mine", 2 * 60_000, provenance=p),
