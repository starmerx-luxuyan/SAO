...
def apply_floor6_boss_corpus(catalog) -> None:
    catalog.weapons.setdefault(
        ...
        WeaponTemplate(
            ...
            base_speed_ms=980,
            reach_m=5.0,
            provenance=_sim("Natural-impact template for The Irrational Cube after its invulnerability puzzle is broken."),
        ),
    )
    ...
    actions = {
        "irrational_cube_face_slam": BossActionDefinition(
            ...
            stagger_ms=680,
            tags=("cube", "slam", "area"),
            provenance=_sim("Damage/timing package for the vulnerable combat phase; not a claimed named canon attack."),
        ),
        "irrational_cube_rotation_burst": BossActionDefinition(
            ...
            max_targets=8,
            stagger_ms=360,
            tags=("cube", "rotation", "area"),
            provenance=_sim("Combat-phase shockwave inspired by the canon rotating-cube body; exact action is simulation."),
        ),
        "irrational_cube_corner_crush": BossActionDefinition(
            ...
            max_targets=2,
            stagger_ms=980,
            tags=("cube", "heavy", "crush"),
            provenance=_sim("Heavy vulnerable-phase attack; exact numbers/action package are simulation."),
        ),
    }
        ...
        BossDefinition(
            ...
            phases=(
                BossPhaseDefinition(
                    ...
                    _inferred(
                        "The Floor 6 boss is a giant golden number-faced cube. Its ordinary invulnerability collapses only after the number-face puzzle is solved; the post-puzzle attack package here is simulation.",
                        PROGRESSIVE_6,
                    ),
                ),
            ),
            ...
            provenance=_inferred(
                "The Irrational Cube is the Floor 6 Floor Boss. Canon/secondary-source material describes a giant golden cube with numbered 3x3 faces; attacks/rotations manipulate rows and columns until a face matches the nine-digit door-puzzle solution, breaking its invulnerability. Boss HP bars and numeric combat stats are simulation.",
                PROGRESSIVE_6,
            ),
        ),
    )
